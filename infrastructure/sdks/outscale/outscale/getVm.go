...
func LookupVm(ctx *pulumi.Context, args *LookupVmArgs, opts ...pulumi.InvokeOption) (*LookupVmResult, error) {
	...
	err = ctx.InvokePackage("outscale:index/getVm:getVm", args, &rv, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupVmOutput(ctx *pulumi.Context, args LookupVmOutputArgs, opts ...pulumi.InvokeOption) LookupVmResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVmResultOutput, error) {
			...
			ref, err := internal.PkgGetPackageRef(ctx)
			if err != nil {
				return LookupVmResultOutput{}, err
			}
...
func (o LookupVmResultOutput) LaunchNumber() pulumi.Float64Output {
	return o.ApplyT(func(v LookupVmResult) float64 { return v.LaunchNumber }).(pulumi.Float64Output)
}
