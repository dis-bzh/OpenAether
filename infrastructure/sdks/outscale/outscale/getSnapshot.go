...
func LookupSnapshot(ctx *pulumi.Context, args *LookupSnapshotArgs, opts ...pulumi.InvokeOption) (*LookupSnapshotResult, error) {
	...
	err = ctx.InvokePackage("outscale:index/getSnapshot:getSnapshot", args, &rv, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSnapshotOutput(ctx *pulumi.Context, args LookupSnapshotOutputArgs, opts ...pulumi.InvokeOption) LookupSnapshotResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSnapshotResultOutput, error) {
			...
			return ctx.InvokeOutput("outscale:index/getSnapshot:getSnapshot", args, LookupSnapshotResultOutput{}, options).(LookupSnapshotResultOutput), nil
...
func (o LookupSnapshotResultOutput) Progress() pulumi.Float64Output {
	return o.ApplyT(func(v LookupSnapshotResult) float64 { return v.Progress }).(pulumi.Float64Output)
}
...
func (o LookupSnapshotResultOutput) VolumeSize() pulumi.Float64Output {
	return o.ApplyT(func(v LookupSnapshotResult) float64 { return v.VolumeSize }).(pulumi.Float64Output)
}
