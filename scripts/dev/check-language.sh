...
#
# CLAUDE.md says "passer le détecteur" — and there was no detector, in either
# repository, which is why the 2026-07-28 switch left ~50 lines behind and a
# later audit still found seven whole files.
#
