...
**[docs/capi-bootstrap.en.md](docs/capi-bootstrap.en.md)**.
...
`docs/deployment-test-matrix.en.md`.
...
([docs/admin-access.en.md](docs/admin-access.en.md)) — Shamir/root/restic
...
| File | Contents |
|---|---|
| [docs/admin-access.en.md](docs/admin-access.en.md) | Day-1 path: escrow, offline PKI, UI access, browser tests |
| [docs/capi-bootstrap.en.md](docs/capi-bootstrap.en.md) | Bootstrap a management via CAPI and make it self-managed |
| [docs/deployment-test-matrix.en.md](docs/deployment-test-matrix.en.md) | What is validated, where, and how |
